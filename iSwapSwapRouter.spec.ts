...
import ISwapPair from '@iSwapProject/iSwap-swap-core/build/IiSwapSwapPair.json'
import SwapPair from '@iSwapProject/iSwap-swap-core/build/iSwapSwapPair.json'
...
import SwapRouter from '../build/iSwapSwapRouter.json'
...
describe('SwapRouter', () => {
  ...
  it('getAmountOut', async () => {
    ...
    await expect(router.getAmountOut(bigNumberify(0), bigNumberify(100), bigNumberify(100))).to.be.revertedWith(
      'iSwapSwapLibrary: INSUFFICIENT_INPUT_AMOUNT'
    )
  ...
  it('getAmountIn', async () => {
    ...
    await expect(router.getAmountIn(bigNumberify(0), bigNumberify(100), bigNumberify(100))).to.be.revertedWith(
      'iSwapSwapLibrary: INSUFFICIENT_OUTPUT_AMOUNT'
    )

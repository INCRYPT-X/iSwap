...
describe('iSwapMaster', () => {
  ...
  it('poolLength', async () => {
    const iSwapToken = new ethers.Contract(iSwapMasterAddress, JSON.stringify(iSwapMaster.abi), provider).connect(
      wallet
    )
    const poolLength = await iSwapToken.poolLength()
  ...
  it('massUpdatePools', async () => {
    ...
    const tx = await iSwapToken.massUpdatePools()
  ...
  it('updatePool', async () => {
    ...
    // const tx = await iSwapToken.updatePool('0x809142af759a8c39ab12f85ade543ed8bd3f164b')
    // 0x3dec41b6dd3876a5e08ebaafbcd7b3cca73885e2cc76fe2ddca8feb338cfe405
    const tx = await iSwapToken.updatePool('0x2A942b802258F50810d4914cF2E5c4f9446Da36a')
  ...
  it('add', async () => {
    ...
    const tx = await iSwapToken.add(1, '0x809142af759a8c39ab12f85ade543ed8bd3f164b', false, {
      ...overrides,
      value: 0
    })
  ...
  it('set', async () => {
    ...
    const tx = await iSwapToken.set('0x2A942b802258F50810d4914cF2E5c4f9446Da36a', 0, false, {
      ...overrides,
      value: 0
    })
